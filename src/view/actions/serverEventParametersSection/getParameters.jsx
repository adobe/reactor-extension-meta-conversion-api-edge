...
import AppDataParametersFields from '../appDataParametersSection/fields';

export default ({ actionSource } = {}) => {
  const isApp = actionSource?.toLowerCase() === CONSTANTS.APP;
  const isDataElement = isDataElementToken(actionSource);
  const showAppData = isApp || isDataElement;
  ...
  return [
    ...
    ...(showAppData
      ? [['appData', null, null, false, null, AppDataParametersFields, {}]]
      : []),
    [
      'eventName',
      'Event Name',
      ...
      <ContextualHelp>
        ...
        <Content>
          <p>
            ...
            performance optimization. You must send this date in GMT time zone.
          </p>
          <p>
            The{' '}
            <strong>
      ...
      <ContextualHelp>
        ...
        <Content>
          ...
          <p>
            ...
            with order numbers 123 and 456, each Conversions API call would need
            to include its respective order number for{' '}
            <strong>
              <code>event_id</code>
            </strong>
